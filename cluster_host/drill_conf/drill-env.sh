...
DEBUG_OPTS=""
MAPR_OPTS="-Djava.security.auth.login.config=/opt/mapr/conf/mapr.login.conf -Dzookeeper.sasl.client=false"
export DRILL_JAVA_OPTS="-Xms$DRILL_MAX_HEAP -Xmx$DRILL_MAX_HEAP -XX:MaxDirectMemorySize=$DRILL_MAX_DIRECT_MEMORY ${DEBUG_OPTS} ${MAPR_OPTS} -XX:MaxPermSize=512M -XX:ReservedCodeCacheSize=1G -ea"
